            ...
            $("#gridBody").jqGrid({
                ...
                colModel: [
                    ...
                    { label: '调拨数量',name:'number', width: 30,align:"center",
                        formatter: function (cellvalue, options, rowObject) {
                            return "<input type='text' class='input-sm form-control' value='0' size='3' onblur='validate(this,"+ rowObject['customStockItem.number'] +")' id='number_"+ cellvalue  +"'/>";
                        }
                    },
    ...
    <div class="row" style="margin-top: -80px">
        <div class="col-md-11">
            <div id="actions" class="form-action">
                <form class="" id="fm" action='<@spring.url relativeUrl = "/stocktransferorder/save"/>'   method="post">
